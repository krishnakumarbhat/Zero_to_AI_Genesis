...
import { ArrowLeft, ArrowRight, Cpu, Eye, Search, Database, GraduationCap, Bot, Gamepad2, Brain } from 'lucide-react';
...
export default function SeasonPage() {
  ...
  if (!season) {
    return (
      <main className="min-h-screen flex items-center justify-center" data-testid="season-not-found">
        <Navbar />
        <div className="text-center pt-24">
          <h1 className="font-heading text-4xl font-bold text-white mb-4">Season Not Found</h1>
          <Link href="/" className="text-season-7 hover:underline">Back to Home</Link>
        </div>
      </main>
    );
  }
